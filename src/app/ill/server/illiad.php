...
$whitelist=array("localhost", "localhost:8003", "localhost:4201", "TODO-purdue.primo.exlibrisgroup.com");
...
$key=" ";    /* TODO: enter Purdue's ILLiad Web Platform API key here  */
$illiadDomain="purdue.illiad.oclc.org";
...
foreach ($xml as $trans){
  ...
  switch ($status){
    ...
    $url="https://$illiadDomain/illiad/rrr/illiad.dll?Action=10&Form=75&Value=$id";
    ...
    case "Awaiting Staff Article Correction":
